...
@wrapt.decorator
def cli_pull_request_scenario(wrapped, instance, args, kwargs):
    """
    ...
    modified_packages = git_util.summarize_changed_mods(instance.modified_files)
...
class CLIAzureDevOpsContext(AzureDevOpsContext):
    ...
    def __init__(self, git_repo, git_source, git_target):
        ...
        self.modified_files = self._modified_files()
    ...
    @cli_pull_request_scenario
    @cli_release_scenario
    def filter(self, test_index):
        """
        :retuen: a list of modified packages
        """
        return []
