...
# _argument_keys = set()
# 'deprecate_info',
# 'dest', 'help', 'option_list', 'options_list',
# 'action', 'arg_group', 'arg_type', 'choices', 'default',
# 'completer', 'configured_default', 'const'
# 'id_part',
# 'is_preview', 'local_context_attribute', 'max_api', 'metavar', 'metave', 'min_api', 'nargs', 'operation_group',  'required', 'resource_type', 'type', 'validator']
...
class AZDevTransArgument:
    ...
    def __init__(self, name, parent_command, table_instance):
        ...
        self._parse_options_list(type_settings)  # TODO: FIX option_list code
        ...
        self._parse_configured_default(type_settings)   # TODO: Don't know
        self._parse_const(type_settings)    # TODO: Don't know
    ...
    def _parse_id_part(self, type_settings):
        ...
        # self.id_part = type_settings.get('id_part', None)
        # self.options_list = type_settings.get('options_list', None)
        # self.default = type_settings.get('default', None)

        # self.required = type_settings.get('required', None)
        # self.help_str = type_settings.get('help', None)
        # self.action = type_settings.get('action', None)
        # self.dest = type_settings.get('dest', None)
        # assert self.name == self.dest
